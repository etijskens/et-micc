...
"""Tests for `{{ cookiecutter.project_name }}.{{ cookiecutter.f2py_module_name }}{{ cookiecutter.suffix }}` package."""

import os
import sys
import pytest

import {{ cookiecutter.package_name }}.{{ cookiecutter.f2py_module_name }}{{ cookiecutter.suffix }} as f90
