...
#
try:
    import {{ cookiecutter.sphinx_html_theme }}
    html_theme = '{{ cookiecutter.sphinx_html_theme }}'    
except ImportError:
    print("Sphinx html theme '{{ cookiecutter.sphinx_html_theme }}' not found. Using 'classic' instead.")
    html_theme = 'classic'    
